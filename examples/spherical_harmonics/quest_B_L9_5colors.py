...
fig.suptitle(r'Version B, $N=2048$, 99 harmonics ($\ell\le%d$): 3D channel embedding $(\psi_2,\psi_3,\psi_4)$ colored by $\ell$, $m$, $|m|$, $\ell-|m|$, and SFC order' % Lmax, fontsize=14, y=0.99)
fig.tight_layout(rect=[0, 0, 1, 0.96])
fig.savefig(os.path.join(HERE, 'quest_B_L9_5colors.png'), dpi=140, bbox_inches='tight')
fig.savefig(os.path.join(HERE, 'quest_B_L9_5colors.pdf'), bbox_inches='tight'); print("SAVED")
